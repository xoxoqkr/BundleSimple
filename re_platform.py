...
def Platform_process5(env, platform, orders, riders, p2,thres_p,interval, end_t = 1000,
                      ...
                      cut_info3 = [100,100], cut_info2= [100,100], stopping_index = 100, clustering = True, revise_type = 'stopping',
                      cut_infoC = [100,100], search_type2 = 'enumerate'):
        ...
        if bundle_para == True:
            ...
            if p > thres_p:
                ...
                feasible_bundle_set, phi_b, d_matrix, s_b, D, lt_matrix, act_considered_ct_num, label_infos, D_rev, sc_add_infos = Bundle_Ready_Processs2(
                    ...
                    revise_type = revise_type, cut_infoC = cut_infoC, search_type2 = search_type2)
